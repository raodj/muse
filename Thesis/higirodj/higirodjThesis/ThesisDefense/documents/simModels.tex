\chapter{Simulation Benchmarks}  \label{sec:models}
...
\textbf{\caption{Parameters in PHOLD benchmark ~\cite{higiro2017multi}}}\label{tab:phold-params}
...
\begin{figure}\centering
  ...
  \end{minipage}
  \textbf{\caption{Impact of varying key parameter values in the PHOLD model~\cite{higiro2017multi}}}\label{fig:phold}
\end{figure}
