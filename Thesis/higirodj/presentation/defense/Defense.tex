...
\section{Methodology}
\section{Results}
\subsection{GSA results}
\subsection{Sequential simulation results}
\subsection{Parallel simulation assessments}
...
\end{figure}
\begin{itemize}
\item Ladder Queue is a priority queue implementation proposed by Tang et al. with amortized O(1) constant time complexity.
...
\item Comparison of execution time using 6 different ladderQ configurations.
...
\item[\ding{185}] Results
\setlength{\itemindent}{0.1in}
\item GSA results
\item Sequential simulation results
\item Parallel simulation assessments
\setlength{\itemindent}{0in}
\item[\ding{186}]Conclusion and Future Work
\end{itemize}
\end{frame}
...
\item[\ding{183}] Background
\item[\ding{184}] Methodology
\item[\ding{185}] \colorbox{red}{Results}
\setlength{\itemindent}{0.1in}
\item \colorbox{yellow}{GSA results}
\item Sequential simulation results
\item Parallel simulation assessments
\setlength{\itemindent}{0in}
\item[\ding{186}]Conclusion and Future Work
...
\item \textbf{lambda} - parameter with marginal influence using \textbf{PHOLD} benchmark in sequential simulations. 

\item \textbf{\%Self-Events} - parameter has a more pronounced influence in comparison to \textbf{lambda} using \textbf{PHOLD} benchmark in parallel simulations. 

\item \textbf{Portables per Cell} - parameter with most influence using \textbf{PCS} in sequential and parallel simulations. 
...
\setlength{\itemindent}{0.1in}
\item GSA results
\item \colorbox{yellow}{Sequential simulation results}
\item Parallel simulation assessments
\setlength{\itemindent}{0in}
\item[\ding{186}]Conclusion and Future Work
\end{itemize}
...
\begin{frame}
\frametitle{\centerline{Sequential simulation results}}
\begin{figure}
...
\begin{minipage}{0.45\linewidth}
\centering
\includegraphics[width=\textwidth, height=5cm]{images/pcs6_runtime_full.png}
\end{minipage}
\textbf{\caption{Sequential simulation runtimes for \textbf{ph3} and \textbf{pcs6} configurations.}}
\end{figure}
\end{frame}
...
\item GSA results
\item Sequential simulation results
\item \colorbox{yellow}{Parallel simulation assessments}
\setlength{\itemindent}{0in}
\item[\ding{186}]Conclusion and Future Work
\end{itemize}
\end{frame}
...
\end{minipage}
\textbf{\caption{Statistics from PH5 configuration with eventsPerLP=20, $\lambda= 10$, \%selfEvents=25\%}}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=\textwidth, height=6cm]{images/pcs8_parallel_75_2.png}
\end{minipage}
\textbf{\caption{Statistics from PCS8 configuration with portables per cell = 75}}
\end{figure}
\end{frame}
...
\item Parallel simulation assessments
\setlength{\itemindent}{0in}
\item[\ding{186}] \colorbox{red}{Conclusion and Future Work}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Implement the multi-tier data structures in a different language and compare performance.
