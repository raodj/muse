...
void Bug::executeMoveIn(BugEvent * current_event, BugState * my_state) {
...
void Bug::executeMoveOut(BugEvent * current_event, BugState * my_state) {
...
void Bug::executeGrow(BugEvent * current_event, BugState * my_state) {
...
void Bug::executeEat(BugEvent * current_event, BugState * my_state) {
...
void Bug::executeScout(BugEvent * current_event, BugState * my_state) {
