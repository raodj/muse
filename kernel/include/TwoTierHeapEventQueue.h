#ifndef TWO_TIER_HEAP_EVENT_QUEUE_H
#define TWO_TIER_HEAP_EVENT_QUEUE_H
...
/** A two-tier-heap aka "2tHeap" or "heap-of-heap" event queue for
    managing events.
...
public:
    ...
    */    
    virtual bool empty() {
        return (agentList.empty() || top()->schedRef.eventPQ->empty());
    }
