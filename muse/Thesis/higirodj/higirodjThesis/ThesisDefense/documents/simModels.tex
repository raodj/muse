...
\textbf{moveIntervalMean} & The average move time of a portable from one PCS cell to another PCS cell. \\

\textbf{callIntervalMean} & The average time before the next call. \\

\textbf{callDurationMean} & The average completion time of a call. \\
