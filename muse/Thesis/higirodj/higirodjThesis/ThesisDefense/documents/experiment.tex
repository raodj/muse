...
\begin{figure}
  ...
  \textbf{\caption{Statistics from PH3 configuration of PHOLD parallel simulation with \textbf{eventsPerLP}=2, $\lambda=1$, \textbf{\%selfEvents}=25\%}\label{fig:par-time-ph3}}
\end{figure}
...
\begin{figure}
  ...
  \end{minipage}
  \textbf{\caption{Statistics from PH4 configuration of PHOLD parallel simulation with \textbf{eventsPerLP}=2, $\lambda=1$, \textbf{\%selfEvents}=25\%}\label{fig:par-time-ph4}}
\end{figure}
...
\begin{figure}
  ...
  \end{minipage}
  \textbf{\caption{Statistics from PH5 configuration of PHOLD parallel simulation with \textbf{eventsPerLP}=2, $\lambda=1$, \textbf{\%selfEvents}=25\%}\label{fig:par-time-ph5}}
\end{figure}
