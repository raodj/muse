#ifndef MUSE_MULTI_THREADED_COMMUNICATOR_H
#define MUSE_MULTI_THREADED_COMMUNICATOR_H
...
*/
class MultiThreadedCommunicator : public muse::Communicator {
...
public:
    /** \brief Default Constructor.
        ...
        GVT messages.
    */
    MultiThreadedCommunicator(MultiThreadedSimulationManager* simMgr,
    ...
    */
    virtual ~MultiThreadedCommunicator() override;
...
private:
    ...
    */
    ...
    /** The simulation manager associated with this
        ...
        object.
    */
    MultiThreadedSimulationManager* const simMgr;
